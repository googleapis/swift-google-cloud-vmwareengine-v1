  ...
  Sendable
{
  ...
  public var hcxActivationKeys: [HcxActivationKey] = []
  ...
  /// Initialize a new instance of `ListHcxActivationKeysResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListHcxActivationKeysResponse().with { $0.hcxActivationKeys = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let hcxActivationKeys = CodingKeys(stringValue: "hcxActivationKeys")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [HcxActivationKey].self, forKey: .hcxActivationKeys)
    {
      self.hcxActivationKeys = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.hcxActivationKeys, forKey: .hcxActivationKeys)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmwareengine.v1.ListHcxActivationKeysResponse"
  }
