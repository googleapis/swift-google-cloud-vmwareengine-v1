...
public struct ListPrivateCloudsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListPrivateCloudsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListPrivateCloudsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmwareengine.v1.ListPrivateCloudsRequest"
  }
