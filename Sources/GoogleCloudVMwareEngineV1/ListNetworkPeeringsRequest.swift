...
public struct ListNetworkPeeringsRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListNetworkPeeringsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListNetworkPeeringsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmwareengine.v1.ListNetworkPeeringsRequest"
  }
