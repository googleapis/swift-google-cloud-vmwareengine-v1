...
public struct ListPrivateConnectionPeeringRoutesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListPrivateConnectionPeeringRoutesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListPrivateConnectionPeeringRoutesRequest().with { $0.parent = ... }
  /// ```
