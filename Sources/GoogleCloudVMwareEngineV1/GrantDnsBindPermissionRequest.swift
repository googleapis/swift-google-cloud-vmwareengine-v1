...
public struct GrantDnsBindPermissionRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GrantDnsBindPermissionRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GrantDnsBindPermissionRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmwareengine.v1.GrantDnsBindPermissionRequest"
  }
