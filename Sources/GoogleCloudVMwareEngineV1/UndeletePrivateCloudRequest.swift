...
public struct UndeletePrivateCloudRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UndeletePrivateCloudRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UndeletePrivateCloudRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmwareengine.v1.UndeletePrivateCloudRequest"
  }
