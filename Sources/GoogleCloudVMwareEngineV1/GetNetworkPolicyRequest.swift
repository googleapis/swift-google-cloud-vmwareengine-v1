...
public struct GetNetworkPolicyRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetNetworkPolicyRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetNetworkPolicyRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmwareengine.v1.GetNetworkPolicyRequest"
  }
