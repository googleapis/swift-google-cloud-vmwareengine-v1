  ...
  Sendable
{
  ...
  public var vmwareEngineNetworks: [VmwareEngineNetwork] = []
  ...
  /// Initialize a new instance of `ListVmwareEngineNetworksResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListVmwareEngineNetworksResponse().with { $0.vmwareEngineNetworks = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let vmwareEngineNetworks = CodingKeys(stringValue: "vmwareEngineNetworks")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [VmwareEngineNetwork].self, forKey: .vmwareEngineNetworks)
    {
      self.vmwareEngineNetworks = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.vmwareEngineNetworks, forKey: .vmwareEngineNetworks)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmwareengine.v1.ListVmwareEngineNetworksResponse"
  }
