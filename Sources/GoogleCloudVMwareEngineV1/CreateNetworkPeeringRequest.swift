...
///
/// [google.cloud.vmwareengine.v1.VmwareEngine.CreateNetworkPeering]: <doc:VmwareEngineClient/createNetworkPeering(request:options:)>
public struct CreateNetworkPeeringRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// (section 3.5)
  public var networkPeeringId: Swift.String = Swift.String()
  ...
  /// Initialize a new instance of `CreateNetworkPeeringRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateNetworkPeeringRequest().with { $0.parent = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let networkPeeringId = CodingKeys(stringValue: "networkPeeringId")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .networkPeeringId) {
      self.networkPeeringId = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.networkPeeringId, forKey: .networkPeeringId)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmwareengine.v1.CreateNetworkPeeringRequest"
  }
