  ...
  Sendable
{
  ...
  public var externalAccessRules: [ExternalAccessRule] = []
  ...
  /// Initialize a new instance of `ListExternalAccessRulesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListExternalAccessRulesResponse().with { $0.externalAccessRules = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let externalAccessRules = CodingKeys(stringValue: "externalAccessRules")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [ExternalAccessRule].self, forKey: .externalAccessRules)
    {
      self.externalAccessRules = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.externalAccessRules, forKey: .externalAccessRules)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmwareengine.v1.ListExternalAccessRulesResponse"
  }
