...
public struct ResetVcenterCredentialsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ResetVcenterCredentialsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ResetVcenterCredentialsRequest().with { $0.privateCloud = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .privateCloud) {
      self.privateCloud = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.privateCloud, forKey: .privateCloud)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmwareengine.v1.ResetVcenterCredentialsRequest"
  }
