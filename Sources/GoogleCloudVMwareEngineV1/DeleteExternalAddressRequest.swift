...
public struct DeleteExternalAddressRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteExternalAddressRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteExternalAddressRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmwareengine.v1.DeleteExternalAddressRequest"
  }
