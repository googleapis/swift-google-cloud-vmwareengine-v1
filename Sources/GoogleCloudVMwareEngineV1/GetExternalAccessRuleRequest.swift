...
public struct GetExternalAccessRuleRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetExternalAccessRuleRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetExternalAccessRuleRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmwareengine.v1.GetExternalAccessRuleRequest"
  }
