  ...
  public func createPrivateCloud(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try PrivateCloud(fromAny: anyValueUnwrapped)
  ...
  public func createExternalAddress(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try ExternalAddress(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func createExternalAccessRule(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try ExternalAccessRule(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func createLoggingServer(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try LoggingServer(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func updateDnsForwarding(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try DnsForwarding(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func createNetworkPeering(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try NetworkPeering(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func createHcxActivationKey(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try HcxActivationKey(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func createNetworkPolicy(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try NetworkPolicy(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func createManagementDnsZoneBinding(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try ManagementDnsZoneBinding(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func createVmwareEngineNetwork(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try VmwareEngineNetwork(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func grantDnsBindPermission(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try DnsBindPermission(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
