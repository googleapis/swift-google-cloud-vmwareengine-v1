...
public struct ListHcxActivationKeysRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListHcxActivationKeysRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListHcxActivationKeysRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmwareengine.v1.ListHcxActivationKeysRequest"
  }
