...
///
/// [google.cloud.vmwareengine.v1.VmwareEngine.CreateNetworkPolicy]: <doc:VmwareEngineClient/createNetworkPolicy(request:options:)>
public struct CreateNetworkPolicyRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// (section 3.5)
  public var networkPolicyId: Swift.String = Swift.String()
  ...
  /// Initialize a new instance of `CreateNetworkPolicyRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateNetworkPolicyRequest().with { $0.parent = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let networkPolicyId = CodingKeys(stringValue: "networkPolicyId")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .networkPolicyId) {
      self.networkPolicyId = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.networkPolicyId, forKey: .networkPolicyId)
