...
public struct ListPrivateCloudsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// A list of private clouds.
  public var privateClouds: [PrivateCloud] = []
  ...
  /// Initialize a new instance of `ListPrivateCloudsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListPrivateCloudsResponse().with { $0.privateClouds = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let privateClouds = CodingKeys(stringValue: "privateClouds")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([PrivateCloud].self, forKey: .privateClouds) {
      self.privateClouds = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.privateClouds, forKey: .privateClouds)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmwareengine.v1.ListPrivateCloudsResponse"
  }
...
extension ListPrivateCloudsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [PrivateCloud] {
    return self.privateClouds
  }
