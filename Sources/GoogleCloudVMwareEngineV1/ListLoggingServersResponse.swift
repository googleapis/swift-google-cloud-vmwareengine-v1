  ...
  Sendable
{
  ...
  public var loggingServers: [LoggingServer] = []
  ...
  /// Initialize a new instance of `ListLoggingServersResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListLoggingServersResponse().with { $0.loggingServers = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let loggingServers = CodingKeys(stringValue: "loggingServers")
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmwareengine.v1.ListLoggingServersResponse"
  }
