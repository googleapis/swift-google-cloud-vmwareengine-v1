...
public struct DeleteLoggingServerRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteLoggingServerRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteLoggingServerRequest().with { $0.name = ... }
  /// ```
