...
public struct Nsx: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  public var state: Nsx.State = Nsx.State()
  ...
  /// Initialize a new instance of `Nsx`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = Nsx().with { $0.internalIp = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Nsx.State.self, forKey: .state) {
      self.state = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmwareengine.v1.Nsx"
  }
