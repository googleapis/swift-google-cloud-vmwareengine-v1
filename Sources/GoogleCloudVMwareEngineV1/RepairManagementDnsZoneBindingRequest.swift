...
public struct RepairManagementDnsZoneBindingRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `RepairManagementDnsZoneBindingRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = RepairManagementDnsZoneBindingRequest().with { $0.name = ... }
  /// ```
