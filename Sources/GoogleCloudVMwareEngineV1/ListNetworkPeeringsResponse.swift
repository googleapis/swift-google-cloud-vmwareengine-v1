  ...
  Sendable
{
  ...
  public var networkPeerings: [NetworkPeering] = []
  ...
  /// Initialize a new instance of `ListNetworkPeeringsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListNetworkPeeringsResponse().with { $0.networkPeerings = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let networkPeerings = CodingKeys(stringValue: "networkPeerings")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([NetworkPeering].self, forKey: .networkPeerings) {
      self.networkPeerings = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.networkPeerings, forKey: .networkPeerings)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmwareengine.v1.ListNetworkPeeringsResponse"
  }
