...
public struct DeleteVmwareEngineNetworkRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteVmwareEngineNetworkRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteVmwareEngineNetworkRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmwareengine.v1.DeleteVmwareEngineNetworkRequest"
  }
