  ...
  Sendable
{
  ...
  public var managementDnsZoneBindings: [ManagementDnsZoneBinding] = []
  ...
  /// Initialize a new instance of `ListManagementDnsZoneBindingsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListManagementDnsZoneBindingsResponse().with { $0.managementDnsZoneBindings = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let managementDnsZoneBindings = CodingKeys(stringValue: "managementDnsZoneBindings")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [ManagementDnsZoneBinding].self, forKey: .managementDnsZoneBindings)
    {
      self.managementDnsZoneBindings = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.managementDnsZoneBindings, forKey: .managementDnsZoneBindings)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmwareengine.v1.ListManagementDnsZoneBindingsResponse"
  }
