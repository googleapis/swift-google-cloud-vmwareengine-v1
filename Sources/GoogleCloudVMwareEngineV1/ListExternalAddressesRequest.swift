...
public struct ListExternalAddressesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListExternalAddressesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListExternalAddressesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmwareengine.v1.ListExternalAddressesRequest"
  }
