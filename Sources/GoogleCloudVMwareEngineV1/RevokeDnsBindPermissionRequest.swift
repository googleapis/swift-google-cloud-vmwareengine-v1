...
public struct RevokeDnsBindPermissionRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// consumer project.
  public var principal: Principal? = nil
  ...
  /// Initialize a new instance of `RevokeDnsBindPermissionRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = RevokeDnsBindPermissionRequest().with { $0.name = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.principal = try container.decodeIfPresent(Principal.self, forKey: .principal)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmwareengine.v1.RevokeDnsBindPermissionRequest"
  }
