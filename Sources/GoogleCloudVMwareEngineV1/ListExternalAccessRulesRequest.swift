...
public struct ListExternalAccessRulesRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListExternalAccessRulesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListExternalAccessRulesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmwareengine.v1.ListExternalAccessRulesRequest"
  }
