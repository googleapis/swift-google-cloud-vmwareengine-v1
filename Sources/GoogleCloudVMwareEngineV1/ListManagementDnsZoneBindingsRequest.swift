...
public struct ListManagementDnsZoneBindingsRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListManagementDnsZoneBindingsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListManagementDnsZoneBindingsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmwareengine.v1.ListManagementDnsZoneBindingsRequest"
  }
