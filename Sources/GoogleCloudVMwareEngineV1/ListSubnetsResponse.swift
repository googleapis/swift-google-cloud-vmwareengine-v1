  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListSubnetsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListSubnetsResponse().with { $0.subnets = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let subnets = CodingKeys(stringValue: "subnets")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Subnet].self, forKey: .subnets) {
      self.subnets = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmwareengine.v1.ListSubnetsResponse"
  }
