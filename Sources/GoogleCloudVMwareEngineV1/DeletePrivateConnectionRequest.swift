...
public struct DeletePrivateConnectionRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeletePrivateConnectionRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeletePrivateConnectionRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmwareengine.v1.DeletePrivateConnectionRequest"
  }
