...
public struct DeleteNetworkPolicyRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteNetworkPolicyRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteNetworkPolicyRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmwareengine.v1.DeleteNetworkPolicyRequest"
  }
