...
public struct UpdateDnsForwardingRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Required. DnsForwarding config details.
  public var dnsForwarding: DnsForwarding? = nil
  ...
  /// Initialize a new instance of `UpdateDnsForwardingRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateDnsForwardingRequest().with { $0.dnsForwarding = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let dnsForwarding = CodingKeys(stringValue: "dnsForwarding")
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmwareengine.v1.UpdateDnsForwardingRequest"
  }
