  ...
  Sendable
{
  ...
  public var externalAddresses: [ExternalAddress] = []
  ...
  /// Initialize a new instance of `ListExternalAddressesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListExternalAddressesResponse().with { $0.externalAddresses = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let externalAddresses = CodingKeys(stringValue: "externalAddresses")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([ExternalAddress].self, forKey: .externalAddresses)
    {
      self.externalAddresses = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.externalAddresses, forKey: .externalAddresses)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmwareengine.v1.ListExternalAddressesResponse"
  }
