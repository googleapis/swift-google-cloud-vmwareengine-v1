...
public struct CreatePrivateCloudRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let privateCloudId = CodingKeys(stringValue: "privateCloudId")
    static let privateCloud = CodingKeys(stringValue: "privateCloud")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .privateCloudId) {
      self.privateCloudId = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.privateCloudId, forKey: .privateCloudId)
    try container.encodeIfPresent(self.privateCloud, forKey: .privateCloud)
