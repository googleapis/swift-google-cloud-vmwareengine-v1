...
public struct Vcenter: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  public var state: Vcenter.State = Vcenter.State()
  ...
  /// Initialize a new instance of `Vcenter`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = Vcenter().with { $0.internalIp = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Vcenter.State.self, forKey: .state) {
      self.state = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmwareengine.v1.Vcenter"
  }
