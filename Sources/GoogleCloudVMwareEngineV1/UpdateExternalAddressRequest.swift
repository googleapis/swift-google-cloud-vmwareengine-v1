...
public struct UpdateExternalAddressRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateExternalAddressRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateExternalAddressRequest().with { $0.updateMask = ... }
  /// ```
