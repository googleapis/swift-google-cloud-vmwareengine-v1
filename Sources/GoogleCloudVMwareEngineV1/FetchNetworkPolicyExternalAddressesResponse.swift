  ...
  Sendable
{
  ...
  /// Initialize a new instance of `FetchNetworkPolicyExternalAddressesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = FetchNetworkPolicyExternalAddressesResponse().with { $0.externalAddresses = ... }
  /// ```
