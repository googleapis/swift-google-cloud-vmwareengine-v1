  ...
  Sendable
{
  ...
  public var privateConnections: [PrivateConnection] = []
  ...
  /// Initialize a new instance of `ListPrivateConnectionsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListPrivateConnectionsResponse().with { $0.privateConnections = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let privateConnections = CodingKeys(stringValue: "privateConnections")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [PrivateConnection].self, forKey: .privateConnections)
    {
      self.privateConnections = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.privateConnections, forKey: .privateConnections)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmwareengine.v1.ListPrivateConnectionsResponse"
  }
