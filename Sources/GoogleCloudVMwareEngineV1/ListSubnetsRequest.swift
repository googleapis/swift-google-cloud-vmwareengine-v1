...
public struct ListSubnetsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListSubnetsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListSubnetsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmwareengine.v1.ListSubnetsRequest"
  }
