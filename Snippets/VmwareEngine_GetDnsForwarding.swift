...
func sample(
  ...
  let response = try await client.getDnsForwarding(
    request: GetDnsForwardingRequest()
      .with {
        $0.name =
          "projects/\(projectId)/locations/\(locationId)/privateClouds/\(privateCloudId)/dnsForwarding"
      }
  )
